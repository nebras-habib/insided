...
class MysqliDb {
	 ...
	 * @param bool $sanitize
	 *        	If query should be filtered before execution
	 *        	
	 ...
	 *
	 * @param
	 *        	string interval in the formats:
	 ...
	 *
	 * @param
	 *        	int increment amount. 1 by default
	 */
	 ...
	 *
	 * @param
	 *        	string column name. null by default
	 */
